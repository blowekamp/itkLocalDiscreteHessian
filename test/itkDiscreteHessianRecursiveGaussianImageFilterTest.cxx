...
int itkDiscreteHessianRecursiveGaussianImageFilterTest( int argc, char *argv[] )
{
  ...
  typedef itk::Local::DiscreteHessianRecursiveGaussianImageFilter< ImageType > HessianFilterType;
